...
namespace MiTiendita.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Nombre,Cantidad,Precio,TiendaID")] Producto producto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Nombre,Cantidad,Precio,TiendaID")] Producto producto)
        {
            if (id != producto.ID)
            {
                return NotFound();
